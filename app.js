...
var budgetController = (function() {
    ...
    return {
        ...
        calculatePercentages: function(cur) {
            ...
            */
            ...
            data.allItems.exp.forEach(function(cur) {
                calcPercentage(cur , data.totals.inc);
            });
        },
        ...
        getIncArr: function(){
            return{
                budgetInc: data.allItems.inc
            }
        },
        getExpArr: function(){
            return{
                budgetExp: data.allItems.exp
            }
        },
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var addIntListItem = ()=>{
        var incArr = budgetCtrl.getIncArr();
        var expArr = budgetCtrl.getExpArr();
        incArr.budgetInc.forEach(el=>{
            UICtrl.addListItem(el, 'inc');
        });
        expArr.budgetExp.forEach(el=>{
